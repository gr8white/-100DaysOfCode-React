...
let _detachAsync = (() => {
  var _ref3 = _asyncToGenerator(function* (projectRoot, options) {
    ...
    if ((0, (_isPlainObject || _load_isPlainObject()).default)(packagesToInstallWhenEjecting)) {
      Object.keys(packagesToInstallWhenEjecting).forEach(function (packageName) {
...
function _load_isPlainObject() {
  return _isPlainObject = _interopRequireDefault(require('lodash/isPlainObject'));
}
