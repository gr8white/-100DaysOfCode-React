...
let extractTemplateApp = exports.extractTemplateApp = (() => {
  var _ref2 = _asyncToGenerator(function* (templateSpec, projectRoot, packageManager = 'npm', config = {}) {
    (_Logger || _load_Logger()).default.notifications.info({ code: (_NotificationCode || _load_NotificationCode()).default.PROGRESS }, 'Extracting project files...');
    ...
    // Update files
    (_Logger || _load_Logger()).default.notifications.info({ code: (_NotificationCode || _load_NotificationCode()).default.PROGRESS }, 'Customizing project...');
