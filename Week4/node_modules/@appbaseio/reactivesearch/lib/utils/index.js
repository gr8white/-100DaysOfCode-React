...
exports.getValidPropsKeys = exports.isIdentical = exports.isEvent = exports.hasCustomRenderer = exports.getComponent = exports.isFunction = exports.composeThemeObject = exports.connect = undefined;
...
var _validProps = require('@appbaseio/reactivecore/lib/utils/validProps');

var _validProps2 = _interopRequireDefault(_validProps);
...
var getValidPropsKeys = exports.getValidPropsKeys = function getValidPropsKeys() {
	...
	return Object.keys(props).filter(function (i) {
		return _validProps2.default.includes(i);
	});
};